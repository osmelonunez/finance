...
POST_PAYLOADS = {
    ...
    "setup.setup_initialize": {
        "owner_username": "release_admin",
        "owner_email": "release-admin@example.test",
        "owner_password": "FinanceTest1",
        "owner_password_confirm": "FinanceTest1",
    },
    "setup.setup_test_connection": {},
    ...
    "budgets.save_budget": {"month": "2026-07", "amount": "500"},
    "budgets.remove_budget": {},
    "movements.add_movement": MOVEMENT_PAYLOAD,
    "movements.import_expenses": {},
    "movements.preview_expense_import": {},
    "movements.import_incomes": {},
    "movements.preview_income_import": {},
    ...
    "reports.save_report": {
        "name": "Release saved report",
        "section": "comparisons",
        "query_string": "section=comparisons&comparison_kind=mom&comparison_period=2026-07",
    },
    "reports.delete_saved_report": {},
    ...
    "management.update_currency": {"currency": "USD"},
    "management.update_modules": {"loans_enabled": "1", "budgets_enabled": "1"},
    "management.reset_db": {},
    "management.seed_demo_data": {},
    "management.clear_demo_data": {},
    "management.toggle_user": {},
    "management.update_role": {"role": "editor"},
    "backups.backups_update_config": {"frequency": "weekly", "weekly_day": "1", "retain_days": "7"},
    "backups.backups_run_now": {},
    "backups.backups_upload": {},
